    ...
    tabItems(
      tabItem(tabName = 'intro',
              ...
              fluidRow(
                ...
                box((introstringMap), width = 24 ,style = "font-family: 'Ariel', sans-serif;
                        font-weight: 500; line-height: 1.1; color: #4d3a7d;"),
                box((introstringCorr), width = 24 ,style = "font-family: 'Ariel', sans-serif;
                        font-weight: 500; line-height: 1.1; color: #4d3a7d;"),
                box((introstringMass), width = 24 ,style = "font-family: 'Ariel', sans-serif;
                        font-weight: 500; line-height: 1.1; color: #4d3a7d;"),
                box((introstringData), width = 24 ,style = "font-family: 'Ariel', sans-serif;
                        font-weight: 500; line-height: 1.1; color: #4d3a7d;")
      ...
      tabItem(tabName = "map",
              ...
              fluidRow(
                ...
                box((statstring), width = 24 ,style = "font-family: 'Ariel', sans-serif;
                        font-weight: 500; line-height: 1.1; color: #4d3a7d;")
              ),
              fluidRow(
      ...
      tabItem(tabName = "corr",
              ...
              sidebarLayout(
                sidebarPanel(
                  ...
                  fluidRow(box(selectizeInput('stat_2','Select stat for vertical axis', choices = corrplot_choices), width = 14))
      ...
      tabItem(tabName = 'bio',
              ...
              sidebarLayout(
                sidebarPanel(
                box((biostring1), width = 24 ,style = "font-family: 'Ariel', sans-serif;
                        font-weight: 500; line-height: 1.1; color: #4d3a7d;"),
                box((biostring2), width = 10 ,style = "font-family: 'Ariel', sans-serif;
                        font-weight: 500; line-height: 1.1; color: #4d3a7d;")),
                  
                mainPanel(
                  #This is where i would like to place an image.
                )
                )
